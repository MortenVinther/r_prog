...
plot.survey.residuals2(standardize=F,reverse.colors=T,dev='png',pointsize=12,nox=2,noy=2,Portrait=F,start.year=1974,end.year=2027,over.all.max=0.5,my.species=NA)
